...
public_hostname = os.environ.get('PUBLIC_HOST_NAME')
keycloak_hostname = os.environ.get('KEYCLOAK_HOST_NAME')
...
c.DockerSpawner.allowed_images = {
   ...
   "atoti"   : "atoti/atoti",
   "custom" : os.environ['DOCKER_JUPYTER_CONTAINER'],
}
...
c.DockerSpawner.http_timeout = 100
c.DockerSpawner.start_timeout = 200
